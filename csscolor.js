...
var grammar = {
    ...
    {"name": "percent", "symbols": ["max100float", {"literal":"%"}], "postprocess": function(d) { return Math.round(2.55*d[0]); }},
    {"name": "max100float$ebnf$1", "symbols": [/[1-9]/], "postprocess": id},
    {"name": "max100float$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "max100float$ebnf$2", "symbols": [/[0-9]/], "postprocess": id},
    {"name": "max100float$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "max100float$ebnf$3", "symbols": [/[0-9]/]},
    {"name": "max100float$ebnf$3", "symbols": [/[0-9]/, "max100float$ebnf$3"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    {"name": "max100float", "symbols": ["max100float$ebnf$1", "max100float$ebnf$2", {"literal":"."}, "max100float$ebnf$3"], "postprocess": function(d) { return parseFloat(d.join("")); }},
    {"name": "max100float$ebnf$4", "symbols": [/[1-9]/], "postprocess": id},
    {"name": "max100float$ebnf$4", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "max100float$ebnf$5", "symbols": [{"literal":"."}], "postprocess": id},
    {"name": "max100float$ebnf$5", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "max100float", "symbols": ["max100float$ebnf$4", /[0-9]/, "max100float$ebnf$5"], "postprocess": function(d) { return parseFloat(d.join("")); }},
