...
var grammar = {
    ...
    {"name": "csscolor", "symbols": ["csscolor$string$1", "_", {"literal":"("}, "_", "max255", "_", {"literal":","}, "_", "max255", "_", {"literal":","}, "_", "max255", "_", {"literal":")"}, "_"], "postprocess": function(d) { return {r: d[4], g: d[8], b: d[12]}; }},
    {"name": "csscolor$string$2", "symbols": [{"literal":"r"}, {"literal":"g"}, {"literal":"b"}, {"literal":"a"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "csscolor", "symbols": ["csscolor$string$2", "_", {"literal":"("}, "_", "max255", "_", {"literal":","}, "_", "max255", "_", {"literal":","}, "_", "max255", "_", {"literal":","}, "_", "max1float", "_", {"literal":")"}, "_"], "postprocess": function(d) { return {r: d[4], g: d[8], b: d[12], a: d[16]}; }},
    ...
    {"name": "csscolor$string$3", "symbols": [{"literal":"h"}, {"literal":"s"}, {"literal":"l"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "csscolor", "symbols": ["csscolor$string$3", "_", {"literal":"("}, "_", "max360", "_", {"literal":","}, "_", "percent", "_", {"literal":","}, "_", "percent", "_", {"literal":")"}], "postprocess": function(d) { return {h: d[4], s: d[8], l: d[12]}; }},
    {"name": "csscolor$string$4", "symbols": [{"literal":"h"}, {"literal":"s"}, {"literal":"l"}, {"literal":"a"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "csscolor", "symbols": ["csscolor$string$4", "_", {"literal":"("}, "_", "max360", "_", {"literal":","}, "_", "percent", "_", {"literal":","}, "_", "percent", "_", {"literal":","}, "_", "max1float", "_", {"literal":")"}], "postprocess": function(d) { return {h: d[4], s: d[8], l: d[12], a: d[16]}; }},
    {"name": "max255$ebnf$1", "symbols": [/[1-9]/], "postprocess": id},
    {"name": "max255$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "max255", "symbols": ["max255$ebnf$1", /[0-9]/], "postprocess": function(d) { return parseInt(d.join("")); }},
    ...
    {"name": "max360", "symbols": ["max360$ebnf$1", /[0-9]/], "postprocess": function(d) { return parseInt(d.join("")); }},
    {"name": "max360", "symbols": [/[1-2]/, /[0-9]/, /[0-9]/], "postprocess": function(d) { return parseInt(d.join("")); }},
    {"name": "max360", "symbols": [{"literal":"3"}, /[0-5]/, /[0-9]/], "postprocess": function(d) { return parseInt(d.join("")); }},
    {"name": "max360$string$1", "symbols": [{"literal":"3"}, {"literal":"6"}, {"literal":"0"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "max360", "symbols": ["max360$string$1"], "postprocess": function(d) { return parseInt(d.join("")); }},
    {"name": "percent", "symbols": ["max100float", {"literal":"%"}], "postprocess": function(d) { return (0.01*d[0]); }},
    {"name": "max100float$ebnf$1", "symbols": [/[0-9]/]},
    {"name": "max100float$ebnf$1", "symbols": [/[0-9]/, "max100float$ebnf$1"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    {"name": "max100float", "symbols": [{"literal":"."}, "max100float$ebnf$1"], "postprocess": function(d) { return parseFloat(d.join("")); }},
    ...
    {"name": "max100float", "symbols": ["max100float$ebnf$2", /[0-9]/, "max100float$ebnf$3"], "postprocess": function(d) { return parseFloat(d.join("")); }},
    ...
    {"name": "max100float$ebnf$5", "symbols": [/[0-9]/, "max100float$ebnf$5"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    {"name": "max100float", "symbols": ["max100float$ebnf$4", /[0-9]/, {"literal":"."}, "max100float$ebnf$5"], "postprocess": function(d) { return parseFloat(d.join("")); }},
    ...
    {"name": "max100float", "symbols": ["max100float$string$1", "max100float$ebnf$6"], "postprocess": function(d) { return parseFloat(d.join("")); }},
    ...
    {"name": "max100float$ebnf$7", "symbols": [{"literal":"0"}, "max100float$ebnf$7"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    {"name": "max100float", "symbols": ["max100float$string$2", "max100float$ebnf$7"], "postprocess": function(d) { return parseFloat(d.join("")); }},
