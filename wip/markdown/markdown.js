...
var grammar = {
    ...
    {"name": "sentenceBody$ebnf$5", "symbols": [/[ \t]/, "sentenceBody$ebnf$5"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    ...
    {"name": "notFragment$ebnf$1", "symbols": [/[^\n\]]/, "notFragment$ebnf$1"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    {"name": "notFragment$ebnf$2", "symbols": [/[^\n\(]/]},
    {"name": "notFragment$ebnf$2", "symbols": [/[^\n\(]/, "notFragment$ebnf$2"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    ...
    {"name": "notFragment$ebnf$3", "symbols": [/[^\n\]]/, "notFragment$ebnf$3"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    ...
    {"name": "notFragment$ebnf$4", "symbols": [/[^\n\)`*_]/, "notFragment$ebnf$4"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    ...
    {"name": "link$ebnf$1", "symbols": [/[^\n\]]/, "link$ebnf$1"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    {"name": "link$string$1", "symbols": [{"literal":"]"}, {"literal":"("}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "link$ebnf$2", "symbols": [/[^\n\)]/]},
    {"name": "link$ebnf$2", "symbols": [/[^\n\)]/, "link$ebnf$2"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
