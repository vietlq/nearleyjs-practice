...
var grammar = {
    ...
    {"name": "ulistitem$ebnf$1", "symbols": [/[ ]/, "ulistitem$ebnf$1"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    {"name": "ulistitem$string$1", "symbols": [{"literal":"*"}, {"literal":" "}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "ulistitem", "symbols": ["ulistitem$ebnf$1", "ulistitem$string$1", "sentence"], "postprocess": function(d) { return {type: 'ulistitem', value: d[2], ident: d[0].length}; }},
    {"name": "sentence", "symbols": ["fragment"], "postprocess": id},
    {"name": "sentence", "symbols": ["normalText"], "postprocess": id},
    {"name": "sentence", "symbols": ["sentence", "fragment"]},
    {"name": "normalText$ebnf$1", "symbols": []},
    {"name": "normalText$ebnf$1", "symbols": [/[^#*\n]/, "normalText$ebnf$1"], "postprocess": function arrconcat(d) {return [d[0]].concat(d[1]);}},
    {"name": "normalText", "symbols": [/[^#*\s\n]/, "normalText$ebnf$1"], "postprocess": function(d) { return {type: 'words', text: d[0] + d[1].join("")}; }},
    ...
    {"name": "italic", "symbols": [{"literal":"*"}, /[^\s]/, "italic$ebnf$1", {"literal":"*"}], "postprocess": function(d) { return {italic: d[1] + d[2].join("")}; }},
    ...
    {"name": "strong", "symbols": ["strong$string$1", /[^\s]/, "strong$ebnf$1", "strong$string$2"], "postprocess": function(d) { return {strong: d[1] + d[2].join("")}; }},
